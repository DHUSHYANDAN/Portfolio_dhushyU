    ...
    <div id="hero">
      <section className="container">
        ...
        <p className="hero-cta">
          <a className="cta-btn cta-btn--hero animate-slide-left " href="contact.html">
            <span
              className="animate-ping absolute inline-flex h-full w-full rounded-full bg-sky-400 opacity-75 bg-red"></span>Get
            in touch</a>
        </p>
      </section>
